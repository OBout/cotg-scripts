...
// @grant        none
// @updateURL https://raw.githubusercontent.com/jacksoncds/cotg-scripts/master/incoming-filter.user.js
// @downloadURL https://raw.githubusercontent.com/jacksoncds/cotg-scripts/master/incoming-filter.user.js
// ==/UserScript==
...
"><span>${name}</span><span class="jscript_incattackfilter_remove" data-player=${name} style="cursor: pointer;">X</span></div></li>`);
        ...
        let players = localStorage.setItem('jscript_incattackfilter', JSON.stringify(current));
        notify();
    }

    function getAllianceMembers() {
        let allianceName = 'The Crazy Pirates'
